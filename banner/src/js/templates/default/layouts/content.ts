...
export default class Content extends AbstractLayout {
  render(): string {
    return `
        ${this.renderTab(
          'tab1',
          new TabContent1(this.translations, this.banner, this.cookies, this.consentId),
          true,
        )}
        ${this.renderTab(
          'tab2',
          new TabContent2(this.translations, this.banner, this.cookies, this.consentId),
        )}
        ${this.renderTab(
          'tab3',
          new TabContent3(this.translations, this.banner, this.cookies, this.consentId),
        )}
        `
  }
